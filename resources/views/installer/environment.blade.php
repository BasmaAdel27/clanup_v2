...
@section('content')
    <form method="POST" action="{{ route('installer.environment.save') }}">
        ...
        <div class="form-group mb-4">
            ...
            <input class="form-control @error('app_name') is-invalid @enderror" type="text" name="app_name" value="{{ env('APP_NAME') }}">
        ...
        <div class="form-group mb-4">
            ...
            <input class="form-control" type="text" name="app_url" value="http://example.com">
        ...
        <div class="form-group mb-4">
            ...
            <input class="form-control" type="text" name="database_hostname" value="127.0.0.1">
        ...
        <div class="form-group mb-4">
            ...
            <input class="form-control" type="text" name="database_port" value="3306">
        ...
        <div class="form-group mb-4">
            ...
            <input class="form-control" type="text" name="database_name" value="">
        ...
        <div class="form-group mb-4">
            ...
            <input class="form-control" type="text" name="database_username" value="">
        ...
        <div class="form-group mb-4">
            ...
            <input class="form-control" type="password" name="database_password" value="">
