...
class Reminder extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ->subject(__('See you at: :event_title', ['event_title' => $this->event->title]))
                    ->greeting(__('See you at: :event_title', ['event_title' => $this->event->title]))
                    ->line(
                    ...
                    ->attachData($this->event->getICalDataForUser($user, ParticipationStatus::accepted()), 'invite.ics', [
